...
export interface SiteAddModel {
  ...
  trailer_link: string,
  site_color: string,
  site_color_hover: string,
  trailer_trap_link: string,
  picture_trap_link: string,
  main_join_link: string,
  slug: string,
  hidden_in_tours: string,
  has_bestof_video: string,
  sitefolder: string,
  sitecolor: string,
  sitecolorhover: string,
  natssiteid: string,
  mobile_ma_site_order: string,
  mobile_clicks: string,
  live: string,
  createdAt: boolean,
  updatedAt: boolean
}

export interface SiteModel extends Sequelize.Model<SiteModel, SiteAddModel> {
  id: number,
  name: string,
  url: string,
  acronym: string,
...
export const Site = sequelize.define<SiteModel, SiteAddModel>('site', {
    id: {
